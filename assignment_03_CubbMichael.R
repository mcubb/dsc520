...
setwd("C:\\Users\\mcubb\\Documents\\GitHub\\dsc520")
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + ggtitle("Height vs. Earning") + xlab("Height (Inches)") + ylab("Earnings (Dollars)")
